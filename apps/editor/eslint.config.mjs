    ...
    rules: {
      "no-restricted-syntax": [
        "error",
        {
          ...
          message:
            "Use <Input> from @/components/ui/input instead of raw <input>. Raw <input> breaks Chinese/Japanese IME composition. For type=\"file\"/\"hidden\"/\"number\"/\"range\"/\"password\", add // eslint-disable-next-line no-restricted-syntax",
        },
        {
